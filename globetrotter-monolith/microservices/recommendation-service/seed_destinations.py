...
each other (see tests/test_recommendation_service.py). That's a known
...
DATA_FILE = os.path.join(SCRIPT_DIR, "data", "destinations.json")
...
with open(DATA_FILE, "w", encoding="utf-8") as f:
    json.dump({"destinations": places}, f, indent=2, ensure_ascii=False)
